...
const EditServiceScreen = ({ match: { params } }) => {
  ...
  const onSubmit = (e) => {
    ...
    // axios
    //   .patch(`https://togedoorfirebase.herokuapp.com/services/${service.name}`, service)
    //   .then((response) => {
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await axios.get("https://togedoorfirebase.herokuapp.com/categories");
